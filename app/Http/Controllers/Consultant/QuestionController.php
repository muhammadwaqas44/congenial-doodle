...
class QuestionController extends Controller
{
    public function questionCategory($scheduleId, $catId)
    {
        ...
        if ($category) {
            ...
            if ($questionsA || $questionsB) {
                return view('consultant-dashboard.question.question-form', compact('category', 'questionsA', 'questionsB', 'scheduleId'));
            } else {
    ...
    public function questionEditCategory($scheduleId, $catId)
    {
        ...
        if ($category) {
            ...
            if ($questionsA || $questionsB) {
                return view('consultant-dashboard.question.edit-question', compact('category', 'questionsA', 'questionsB', 'scheduleId', 'aArray', 'bArray'));
            } else {
                return redirect()->back();
            }
        } else {
