                ...
                <div class="row">
                    <div class="col-12">
                        <div class="photo-full-div">
                            ...
                            <ul>
                                <li>
                                    <a href="{{route('photo-editor', $outlet->schedule_id)}}">
                                ...
                                <li>
                                    <a href="{{route('narrative-editor', $outlet->schedule_id)}}">
                                        <div class="action-div-img">
                                            <div class="insid-img-div">
                                ...
                                <li>
                                    <a href="{{route('transaction-editor', $outlet->schedule_id)}}">
                                        <div class="action-div-img">
                                            <div class="insid-img-div">
                                                ...
                                                <div class="card-body card-body-giv-wdth">
                                                    ...
                                                    <table class="table table-responsive-xl mx-wdth-table">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    @if($marks->where('category_id',$category->id)->count() == 0)
                                                                        <a href="{{route('detail-category-marks-editor',['scheduleId' => $outlet->schedule_id,'catId' =>$category->id])}}">
                                                                    ...
                                                                    @else
                                                                        <a href="{{route('edit-detail-category-marks-editor',['scheduleId' => $outlet->schedule_id,'catId' =>$category->id])}}">
                                                                            <div class="action-div-img-table">
                                                                                <div class="insid-img-div">
                                                                                <span class="bkgd-clr-icn3"><i
                                                                                            class="fas fa-bars"></i></span>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="{{route('transaction-listing-editor', $outlet->schedule_id)}}">
                                                                    <div class="action-div-img-table">
                                                                        <div class="insid-img-div">
                                                                            <span class="bkgd-clr-icn3"><i
                                                                                        class="fas fa-bars"></i></span>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="{{route('lodging-photo-listing-editor', $outlet->schedule_id)}}">
                                                                <div class="action-div-img-table">
                                                                    <div class="insid-img-div">
                                                                            <span class="bkgd-clr-icn3"><i
                                                                                        class="fas fa-bars"></i></span>
...
@section('script')
    <script>
        ...
        $('#update-outlet-time').on('submit', function (e) {
            ...
            $.ajax({
                type: 'POST',
                url: "{{route('edit-outlet-post-editor', $outlet->id)}}",
