                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-6 col-lg-6 col-xl-4">
                            <div class="card-box noradius noborder bg-default">
                                ...
                                <h1 class="m-b-20 text-white counter">{{$activeEditor}}</h1>
                        ...
                        <div class="col-xs-12 col-md-6 col-lg-6 col-xl-4">
                            <div class="card-box noradius noborder bg-warning">
                                ...
                                <h6 class="text-white text-uppercase m-b-20">Complete Evaluations</h6>
                                <h1 class="m-b-20 text-white counter">{{$completeEditor}}</h1>
                        ...
                        <div class="col-xs-12 col-md-6 col-lg-6 col-xl-4">
                            <div class="card-box noradius noborder bg-info">
                                ...
                                <h6 class="text-white text-uppercase m-b-20">Pending Evaluations</h6>
                                <h1 class="m-b-20 text-white counter">{{$pendingEditor}}</h1>
