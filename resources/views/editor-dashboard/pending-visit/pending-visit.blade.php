                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered text-center" id="data-table-pending-editor">
                                        <thead>
                                        <tr>
                                            <th style="width:100px">Visit Date</th>
                                            <th style="width:100px">Hotel Brand</th>
{{--                                            <th style="width:100px">Sub brand</th>--}}
                                            <th style="width:60px">Location name</th>
...
@section('script')
        <script type="text/javascript">
            $(document).ready(function () {
                var table = $('#data-table-pending-editor').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('pending-visit-editor') }}",
                    columns: [
                        {data: 'date'},
        ...
        <script>
            ...
            function startEvaluationEditor(id){
                $.ajax({
                    type: 'GET',
                    url: "/editor/start-evaluation-editor/"+id,
                    success: function (response, status) {
                        if (response.result == 'success') {
                            $.unblockUI();
                            window.toastr.success(response.message);
                            setTimeout(function () {
                                window.location.href="/editor/visit-detail-editor/"+id;
                            }, 1000);
