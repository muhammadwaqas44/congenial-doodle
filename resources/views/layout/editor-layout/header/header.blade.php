        ...
        <ul class="list-inline float-right mb-0">
                        <li class="list-inline-item dropdown notif">
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-arrow dropdown-lg">
                                ...
                                <div class="dropdown-item noti-title">
                                    <h5>
                                        <small><span class="label label-danger pull-xs-right notify-number2"></span>Allerts</small>
                                    </h5>
                                </div>
                                ...
                                <!-- All-->
                                <a href="{{route('read-all-editor-notifications')}}" class="dropdown-item notify-item notify-all">
                                    Read All
                                </a>
            ...
            <li class="list-inline-item dropdown notif">
                ...
                <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                    ...
                    <a href="{{route('edit-profile-editor')}}" class="dropdown-item notify-item">
