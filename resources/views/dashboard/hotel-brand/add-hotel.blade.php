                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <form id="add_hotel_brand" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 col-xl-12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" name="address_one" id="address_one"
                                                               type="text"
                                                               placeholder="Address One" required>
                                                    </div>
                                                    <div class="form-group">
                                                        <input class="form-control" name="address_two" id="address_two"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group id_country ">

                                                        <label for="exampleFormControlSelect1">Country<span class="asterik">*</span></label>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        <label for="exampleFormControlSelect1">
                                                            Note</label>
                                                        <textarea class="form-control" name="notes" id="notes" cols="60"
                                                                  rows="6"></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-lg-12">
                                                    @if($hotelbrand != '')
                                                        <button type="submit" class="btn btn-primary btn-chng1"
                                                                id="update_hotel">Update Hotel Brand
                                                        </button>
                                                        <input type="hidden" name="id" value="{{$hotelbrand->id}}">
                                                    @else
                                                        <button type="submit" class="btn btn-primary btn-chng1"
                                                                id="add_hotel">Add Hotel Brand
                                                        </button>
                                                    @endif
                                                </div>
                                            </div>
...
@section('script')
    ...
    <script>
        $('#add_hotel').click(function (e) {
            e.preventDefault();
            var form = $('form#add_hotel_brand').serialize();
            ...
            $.ajax({
                ...
                success: function (response, status) {
                    if (response.result == 'success') {
                        ...
                        setTimeout(function () {
                            window.location.href= "{{route('hotels-listing')}}";
                        }, 1000);
        ...
        $(document).ready(function () {
            @if($hotelbrand)
            $('#brand_name').val('{{$hotelbrand->brand_name}}');
            $('#city').val('{{$hotelbrand->city}}');
            $('#address_one').val('{{$hotelbrand->address_one}}');
            $('#address_two').val('{{$hotelbrand->address_two}}');
            $('#notes').val('{{$hotelbrand->notes}}');
            $('#zip').val('{{$hotelbrand->zip}}');
            $('.id_state').val('{{$hotelbrand->state}}');
{{--            $('.id_state option[value={{$hotelbrand->state}}]').attr('selected','selected');--}}
            $('.id_country').val('{{$hotelbrand->country}}');
            @endif
        });
        $('#update_hotel').click(function (e) {
            e.preventDefault();
            var form = $('form#add_hotel_brand').serialize();
            ...
            $.ajax({
                type: 'POST',
                url: "{{route('edit-hotel-brand-post')}}",
                data: form,
                success: function (response, status) {
                    if (response.result == 'success') {
                        $.unblockUI();
