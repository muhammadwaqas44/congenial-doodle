...
@section('content')
    <div class="content-page">
        ...
        <div class="content">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 col-xl-12">
                                                <form id="add_hotel_location" enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group brand">
                                                                ...
                                                                <select class="form-control" name="brand_id"
                                                                    ...
                                                                    @if($hotelLocation)
                                                                        <option
                                                                            value="{{$hotelLocation->brand_id}}">{{isset($hotelLocation->brand->brand_name)?$hotelLocation->brand->brand_name:'Select'}}
                                                                        </option>
                                                                    @else
                                                                    ...
                                                                    @foreach($hotelBrands as $hotelBrand)
                                                                        <option
                                                                            value="{{$hotelBrand->id}}">{{$hotelBrand->brand_name}}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="form-group sub_brand">
                                                                ...
                                                                <select class="form-control" name="sub_brand_id"
                                                                    ...
                                                                    @if($hotelLocation)
                                                                        ...
                                                                        <option
                                                                            value="{{$hotelLocation->sub_brand_id}}">{{isset($hotelLocation->subbrand->sub_brand)?$hotelLocation->subbrand->sub_brand:'Select'}}
                                                                        </option>
                                                                    @else
                                                                        <option value="">Select</option>
                                                                    ...
                                                                    @foreach($subBrands as $subBrand)
                                                                        <option
                                                                            value="{{$subBrand->id}}">{{$subBrand->sub_brand}}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="form-group brand">
                                                                <label for="exampleFormControlSelect1">
                                                                    Company<span class="asterik">*</span></label>
                                                                <select class="form-control" name="company_id"
                                                                        id="exampleFormControlSelect1">
                                                                    @if($hotelLocation)
                                                                        <option
                                                                            value="{{$hotelLocation->company_id}}">{{isset($hotelLocation->company->title)?$hotelLocation->company->title:'Select'}}
                                                                        </option>
                                                                    @else
                                                                        <option value="">Select</option>
                                                                    @endif
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input class="form-control"
                                                                       name="address_one"
                                                                       type="text" id="address_one"
                                                                       placeholder="Address One"
                                                                       required="">
                                                            </div>
                                                            <div class="form-group">
                                                                <input class="form-control" id="address_two"
                                                                       name="address_two"
                                                                       type="text"
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group">
                                                                <label>ZIP/Postal
                                                                    Code<span class="asterik">*</span></label>
                                                                <input class="form-control"
                                                                       name="zip" id="zip"
                                                                       type="text"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="form-group state">
                                                                <label for="exampleFormControlSelect1">
                                                                    U.S State/Candian
                                                                    Province<span class="asterik">*</span></label>
                                                                                ...
                                                                                <div class="col-lg-6">
                                                                                    <div class="form-group region">
                                                                                        ...
                                                                                        <select
                                                                                            ...
                                                                                            @if($hotelLocation)
                                                                                                <option
                                                                                                    value="{{$hotelLocation->region}}"
                                                                                                    selected>{{$hotelLocation->region}}
                                                                                                </option>
                                                                                            @else
                                                                                                <option value="">
                                                                                                    Select
                                                                                ...
                                                                                <div class="col-lg-6">
                                                                                    <div class="form-group type">
                                                                                        ...
                                                                                        <select class="form-control"
                                                                                            ...
                                                                                            @if($hotelLocation)
                                                                                                <option
                                                                                                    value="{{$hotelLocation->type}}"
                                                                                                    selected>{{$hotelLocation->type}}
                                                                                                </option>
                                                                                            @else
                                                                                                <option value="">
                                                                                                    Select
                                                                                ...
                                                                                <div class="col-lg-6">
                                                                                    <div class="form-group star_rating">
                                                                                        <label
                                                                                            for="exampleFormControlSelect1">
                                                                                            Star
                                                                                            Rating<span class="asterik">*</span></label>
                                                                                        <select class="form-control"
                                                                                                name="star_rating"
                                                                                                id="exampleFormControlSelect1">
                                                                                            @if($hotelLocation)
                                                                                                <option
                                                                                                    value="{{$hotelLocation->star_rating}}"
                                                                                                    selected>{{$hotelLocation->star_rating}}
                                                                                                </option>
                                                                                            @else
                                                                                                <option value="">
                                                                                                    Select
                                                ...
                                                {{--<i--}}
                                                {{--class="fas fa-user"></i> Add Company</a>--}}
                                                {{--</div>--}}
            ...
            @section('script')
                <script>
                    $("#notes_location").on('keyup', function (event) {
                        var count = $("#notes_location").val().length;
                        if (count > 2000) {
                ...
                <script>
                    $('#add_location').click(function (e) {
                        e.preventDefault();
                        var form = $('form#add_hotel_location').serialize();
                        ...
                        $.ajax({
                            ...
                            success: function (response, status) {
                                if (response.result == 'success') {
                                    ...
                                    setTimeout(function () {
                                        window.location.href = "{{route('allHotelLocation')}}";
                                    }, 1000);
                    ...
                    $(document).ready(function () {
                        @if($hotelLocation)
                        $('#location_name').val('{{$hotelLocation->location_name}}');
                        $('#city').val('{{$hotelLocation->city}}');
                        $('#address_one').val('{{$hotelLocation->address_one}}');
                        $('#address_two').val('{{$hotelLocation->address_two}}');
                        $('#notes_location').val('{{$hotelLocation->notes}}');
                        $('#zip').val('{{$hotelLocation->zip}}');
                        $('.state option[value={{$hotelLocation->state}}]').attr('selected', 'selected');
                        $('.country option[value={{$hotelLocation->country}}]').attr('selected', 'selected');
                        @endif
                    });
                    $('#update_location').click(function (e) {
                        ...
                        $.ajax({
                            type: 'POST',
                            url: "{{route('editHotelLocationPost')}}",
                            data: form,
                            success: function (response, status) {
                                if (response.result == 'success') {
                                    $.unblockUI();
