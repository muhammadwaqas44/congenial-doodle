                                    ...
                                    <div class="card-body card-body-giv-wdth">
                                        <table class="table table-responsive-xl mx-wdth-table text-center table-bordered">
                                            ...
                                            @foreach($oultets as $oultet)
                                                <tr>
                                                    <th scope="row">{{isset($oultet->category->name)?$oultet->category->name:'No'}}</th>

                                                    <td>{{$total_possible[$oultet->category_id]}}</td>
                                                    <td>{{$marksSum[$oultet->category_id]}}</td>
                                                    <td>
                                                        {{isset($marksSum[$oultet->category_id],$total_possible[$oultet->category_id])?number_format(($marksSum[$oultet->category_id]/$total_possible[$oultet->category_id])*100,2):0}}
                                                        %
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        {{isset($marksPreviousSum[$oultet->category_id],$total_possible[$oultet->category_id])?number_format(($marksPreviousSum[$oultet->category_id]/$total_possible[$oultet->category_id])*100,2):0}}
                                                        %
                                                    </td>
                                                    <td>
                                                        {{isset($marksSum[$oultet->category_id],$total_possible[$oultet->category_id],$marksPreviousSum[$oultet->category_id])?number_format((($marksSum[$oultet->category_id]/$total_possible[$oultet->category_id])*100)- (($marksPreviousSum[$oultet->category_id]/$total_possible[$oultet->category_id])*100),2):0}}
                                                        %
                                                    </td>
                                                </tr>
                                            @endforeach
