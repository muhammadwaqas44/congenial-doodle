                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 graph-colm">
                            <div class="graph-full-div">
                                ...
                                <a href="{{route('visit-detail-company',$scheduleId)}}" class="button-graph"><< Rerturn
                                    to Visit Summary </a>
                                <div>
                                    <div class="card mb-3">

                                        <div class="card-body columnchart_responc">
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 graph-colm">
                            <div class="graph-full-div">
                                <div class="card mb-3">
                                    <div class="card-body outlet_respons_cb">

                                        <table class="table outlet_respons_first">
                                            <thead>
                                            <tr>
                                                <th scope="col">{{$categoryName->name}} Total</th>
                                ...
                                <div class="graph-full-div1">
                                    ...
                                    <div class="card mb-3">
                                        <div class="card-body card-body-giv-wdth">
                                            ...
                                            <table class="table outlet_respons text-center">
                                                <thead>
                                                <tr>
                                                ...
                                                @foreach($questionsA[$category->name] as  $question)
                                                    <tr>
                                                        <th scope="row">{{$i++}}</th>
                                                ...
                                                @endforeach
                                                @foreach($questionsB[$category->name] as  $question)
                                                    <tr>
                                                        <th scope="row">{{$i++}}</th>
                                                        <td class="txt-justify">{{$question->question}}</td>
                                                        <td>{{$question->possible_point}}</td>
            ...
            function drawChart() {
                var data = google.visualization.arrayToDataTable([
                    ['Element', 'Density', {role: 'style'}],
                        @foreach($categories as $category)
                    ['{{$category->name}}', {{$marks[$category->name]->sum('value')}}, '#b87333'],
                    @endforeach
                ]);
