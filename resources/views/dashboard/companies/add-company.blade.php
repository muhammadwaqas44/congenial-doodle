...
{{--                                                <div class="col-lg-6">--}}
{{--                                                    <div class="form-group">--}}
{{--                                                        <label> Brand<span class="asterik">*</span></label>--}}
{{--                                                        <select class="form-control2" name="brand_id">--}}
...
{{--                                                            <span data-toggle="modal" data-target="#myModal2"><i--}}
...
{{--                                                        <select class="form-control2" name="sub_brand_id">--}}
{{--                                                            <option value="">Select</option>--}}
...
{{--                                                        </select>--}}
{{--                                                        <div class="add-div-company">--}}
{{--                                                    <span data-toggle="modal" data-target="#myModal3"><i--}}
{{--                                                                class="fas fa-plus"></i></span>--}}
...
{{--                                                <div class="col-lg-12">--}}
{{--                                                    <div class="form-group">--}}
{{--                                                        <label>Location<span class="asterik">*</span></label>--}}
{{--                                                        <select class="form-control1" name="hotel_location_id">--}}
{{--                                                            <option value="">Select</option>--}}
...
{{--                                                        </select>--}}
{{--                                                        <div class="add-div-company">--}}
{{--                                                            <span data-toggle="modal" data-target="#myModalLocation"><i--}}
{{--                                                                        class="fas fa-plus"></i></span>--}}
{{--                                                        </div>--}}
{{--                                                    </div>--}}
{{--                                                </div>--}}
...
@section('script')
    <script>
        ...
        $('form#add_company').on('submit', function (e) {
            e.preventDefault();
