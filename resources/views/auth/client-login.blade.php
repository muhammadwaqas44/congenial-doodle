                ...
                <div class="auto_container">
                    <div class="display_table display_table_revrs">
                        <div class="t_mainDetail_left">
                            <form class="sign-in-form" data-toggle="validator" role="form" id="sign-in-client">
                                @csrf
...
@section('js')
    <script>
        $('form#sign-in-client').on('submit', function (e) {
            e.preventDefault();
            var form = $('form#sign-in-client').serialize();
            $.blockUI({
                css: {
                    border: 'none',
                    padding: '15px',
            ...
            $.ajax({
                ...
                success: function (response, status) {
                    if (response.result == 'success') {
                        ...
                        setTimeout(function () {
                            window.location.href = "{{route('client-view')}}";
                        }, 3000);
