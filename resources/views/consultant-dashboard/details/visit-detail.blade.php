                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-xl-12">
                                        <div class="row">
                                            ...
                                            <div class="form-group " style="margin-top: 10px;">
                                                <h1 class="details-txt-h">Hotel Brand: <span class="details-txt-h-span">{{isset($schedule->brand)?$schedule->brand->brand_name:'No Hotel Brand'}}
                ...
                <div class="col-12">
                    <div class="photo-full-div giv-margin">
                        ...
                        <ul>
                            ...
                            <li>
                                <div class="action-div-img">
                                    <a href="{{route('narrative',$scheduleId)}}">
                                        <div class="insid-img-div">
                            ...
                            <li>
                                <div class="action-div-img">
                                    <a href="{{route('lodging',$scheduleId)}}">
                                        <div class="insid-img-div">
                        ...
                        <div style="margin-top: 10px;">
                            <div class="card mb-3">
                                <div class="card-body card-body-giv-wdth">
                                    ...
                                    <table class="table Lodging_responc">
                                        <thead>
                                        <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($marks->where('category_id',$lodging->category_id)->count() == 0)
                                                        <a href="{{route('detail-category-marks',['scheduleId' => $scheduleId,'catId' =>$lodging->category_id])}}"
                                                           class="btn btn-primary btn-sm viw-btn-sh">Add
                                                            Lodging Report</a>
                                                    @else
                                                        <a href="{{route('edit-detail-category-marks',['scheduleId' => $scheduleId,'catId' =>$lodging->category_id])}}"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <td>
                                                    <a href="{{route('lodging-photo-listing', $scheduleId)}}"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <td>
                                                    <a href="{{route('narrative-listing', $scheduleId)}}"
                ...
                <div class="col-12">
                    <div class="photo-full-div giv-margin">
                        ...
                        <ul>
                            <li>
                                <div class="action-div-img">
                                    <a href="{{route('outlet',$scheduleId)}}">
                        ...
                        <div style="margin-top: 10px;">
                            <div class="card mb-3">
                                <div class="card-body card-body-giv-wdth">
                                    ...
                                    <table class="table outlet_2_respon">
                                        <thead>
                                        <tr>
                                        ...
                                        @foreach($oultets as $oultet)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{route('edit-outlet', $oultet->id)}}"
                                                       class="btn btn-primary btn-sm viw-btn-sh">Edit
                                                        Outlet</a>
...
@section('script')
    <script type="text/javascript">
        function deleteCategory(category, type){
            ...
            var url = "{{route('delete-visit-detail',[':type', ':category'])}}";
