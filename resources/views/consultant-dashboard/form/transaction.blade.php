                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-xl-12">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        <label> Server <span class="asterik">*</span></label>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        <label>Transaction Date<span class="asterik">*</span></label>
                                                        <input class="form-control" id="datetimepickerVisit" type="text" name="time" autocomplete="off" placeholder="Select a Date">
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        <label>Transaction Amount<span class="asterik">*</span></label>
                                                        <input class="form-control"  type="text" name="amount" maxlength="10" autocomplete="off" placeholder="Transaction Amount" onkeypress="return isNumberKey(event)" />
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        <label>Amount Paid<span class="asterik">*</span></label>
                                                        <input class="form-control" type="text" maxlength="10" name="amount_paid" autocomplete="off" placeholder="Amount Paid" onkeypress="return isNumberKey(event)">

                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        <label>Transaction Cheque Number<span class="asterik">*</span></label>
                                                        <input class="form-control"  type="text" name="transaction_check_number" autocomplete="off" placeholder="Transaction Cheque Number" onkeypress="return isNumberKey(event)" />
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        <label>Payment Method<span class="asterik">*</span></label>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        <label>Promotion/Coupon Used<span class="asterik">*</span></label>
...
@section('script')
    ...
    <script>
        ...
        $('form#transaction-form').on('submit', function (e) {
            ...
            $.ajax({
                type: 'POST',
                url: "{{route('transaction-post', $scheduleId)}}",
                data: formData,
                processData: false,
                contentType: false,
                cache: false,
