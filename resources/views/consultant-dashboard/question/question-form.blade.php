                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="possible_point" onkeypress="return isNumberKey(event)"  min="0" onKeyDown="if(this.value.length==2 && event.keyCode!=8) return false;"  name="possible_point" type="number" required>
                                    </div>
                                </div>
                            </div>
                ...
                $.ajax({
                    ...
                    success: function (response, status) {
                        if (response.result == 'success') {
                            ...
                            window.toastr.success(response.message);
                            setTimeout(function () {
                                window.location.href ="{{route('edit-detail-category-marks',['scheduleId' => $scheduleId,'catId' =>$category->id])}}";
                            }, 1000);
                        } else if (response.result == 'error') {
                            $.unblockUI();
                            window.toastr.error(response.message);
