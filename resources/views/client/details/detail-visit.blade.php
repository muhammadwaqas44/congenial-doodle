                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 graph-colm">
                            <div class="graph-full-div1">
                                <h1 style="width: 50%; float: left;">{{isset($schedule->brand)?$schedule->brand->brand_name:'No Hotel Brand'}}</h1>
                                <h1 style="width: 50%; float: left;" class="text-right">Vist Date
                                    : {{\Carbon\Carbon::parse($schedule->date)->format('d F Y')}}</h1>
                                <div style="text-align: center; margin-top: 10px; float: left; width: 100%;">
                                    <a href="{{route('summary-score',$schedule->id)}}" class="button-graph">
                                        ...
                                        <table class="table table-responsive-xl mx-wdth-table">
                                            ...
                                            @foreach($oultets as $oultet)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{route('report-detail-outlet-Client',['scheduleId'=>$schedule->id,'catId'=>$oultet->category->id])}}"> Most Recent Visit</a> <br>
                                        ...
                                        <table class="table table-responsive-xl mx-wdth-table">
                                            ...
                                            @foreach($lodgings as $lodging)
                                                <tr>
                                                    ...
                                                    <td>
                                                    <td>
                                                        <a href="{{route('report-detail-Client',['scheduleId'=>$schedule->id,'catId'=>$lodging->category->id])}}"> Most Recent Visit</a> <br>
                                                        {{--<br>--}}
                                                        {{--<a href="{{route('portal-detail')}}"> Additional Report </a>--}}
                                                    </td>
                                                </tr>
